        ...
        <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
                ...
                <path class="cls-1"
                    ...
                    transform="translate(-0.25 -2.41)" />
                <polygon class="cls-2" points="20 18.18 20 25.09 0 16.56 0 16.55 8.09 13.1 8.1 13.1 20 18.18" />
                <polygon class="cls-3" points="20 1.09 20 8.01 8.1 13.09 8.09 13.1 0 9.64 0 9.63 20 1.09" />
                <polygon class="cls-3" points="0 9.64 8.09 13.1 0 16.55 0 9.64" />
                <polygon class="cls-2"
                ...
                <polygon class="cls-4" points="182.52 0.2 173.68 26.32 169.58 26.36 175.92 8.64 178.94 0 182.52 0.2" />
            </g>
        </g>
    </svg>
</template>
...
const colorModePref = ref('light');

const cssProps = computed(() => {
    return {
        '--primary': colorModePref.value === 'light' ? '#4F46E5' : '#A5B4FC',
        '--secondary': colorModePref.value === 'light' ? '#6B7280' : '#D1D5DB',
    };
})
</script>
